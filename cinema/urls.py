...
from .views import CancelOrderView, HomeView, OrderConfirmView, OrderListView, OrderSuccessView, SeatSelectionView, ShowtimeDetailView, SnackDetailView, SnackListView, TicketPDFView
